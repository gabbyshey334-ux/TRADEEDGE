...
export function LegalLayout({
  ...
  return (
    <main className="min-h-screen bg-[#080a0f] text-[#e8edf5]">
      <header className="border-b border-[#1c2235] bg-[#080b11]">
        <div className="mx-auto flex max-w-3xl items-center justify-between px-5 py-5 sm:px-8 sm:py-6">
          ...
          <Link
            href="/"
            className="font-mono uppercase text-[#8892a4] hover:text-[#00ff88] transition-colors"
      ...
      <article className="mx-auto max-w-3xl px-5 py-12 sm:px-8 sm:py-16">
        <div
          ...
          style={{ fontSize: "11px", letterSpacing: "0.32em", color: "#00ff88" }}
        >
          {eyebrow}
        </div>
        <h1
        ...
        <p
          className="mt-4 font-mono uppercase text-[#8892a4]"
          style={{ fontSize: "11px", letterSpacing: "0.22em" }}
        >
        ...
        <nav
          ...
          className="mt-10 rounded-lg border border-[#1c2235] bg-[#0c0f17] p-5 sm:p-6"
        >
          <div
            className="font-mono uppercase mb-3 text-[#00ff88]"
        ...
        <footer className="mt-16 border-t border-[#1c2235] pt-6 flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:justify-between">
          <Link
            href="/"
            className="font-mono uppercase text-[#8892a4] hover:text-[#00ff88] transition-colors"
            style={{ fontSize: "11px", letterSpacing: "0.22em" }}
...
export function LegalList({ items }: { items: ReactNode[] }) {
  return (
    <ul className="space-y-2 list-disc pl-5 marker:text-[#4a5568]">
      {items.map((item, i) => (
        <li key={i}>{item}</li>
      ))}
    </ul>
...
export function LegalEmail({ address }: { address: string }) {
  return (
    <a
      href={`mailto:${address}`}
      className="font-mono text-[#00ff88] hover:underline"
    >
      {address}
    </a>
  );
